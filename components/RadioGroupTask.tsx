...
const types = [
    {
      id: 'todo',
      name: 'To Do',
      description: 'A task that is yet to begin',
      color: 'bg-red-500',
    },
    {
      id: 'inprogress',
      name: 'In Progress',
      description: 'A task that is being worked',
      color: 'bg-yellow-500',
    },
    {
      id: 'done',
...
function RadioGroupTask() {
    let [newTaskType, setNewTaskType] = useBoardStore((state) => [state.newTaskType,state.setNewTaskType])
